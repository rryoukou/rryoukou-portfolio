...
import { Github, ExternalLink, Mail, Linkedin, Code2, Rocket, Terminal, Database, Globe, ShieldAlert, ShieldCheck, Newspaper } from "lucide-react";
...
const BentoGrid = () => {
  ...
  const projects = [
    {
      title: "Movie App",
      desc: "Real-time cinema scanning system. Built with React for rapid mission deployment. Uses advanced API decryption for live intel.",
      tech: ["React", "API", "JS"],
    ...
    },
    {
      ...
      desc: "E-commerce logistics hub. Advanced inventory management with Laravel. Optimized for high-frequency transactions.",
    ...
    },
    {
      ...
      desc: "Knowledge database management. Efficient tracking using PHP/MySQL. Secured member authentication.",
      tech: ["PHP", "MySQL"],
    ...
    },
    {
      ...
      desc: "Retail interface for high-performance gear. UI/UX optimized for combat-level speed.",
      tech: ["HTML", "CSS"],
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.to(".bento-item", {
        ...
        duration: 1.2,
        stagger: 0.1,
        ease: "power3.out", // Smoother for mission logs
        scrollTrigger: {
          ...
          onEnter: () => {
            ...
            titles.forEach((title: any) => scrambleText(title, title.innerText));
          }
        }
      });
    ...
    <section id="work" className="py-20 px-6 bg-slate-950" ref={gridRef}>
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h2 className="text-sm font-bold text-primary uppercase tracking-[0.3em] mb-2 transition-colors duration-700">Stark Industries // Classified</h2>
            <h3 className="text-3xl md:text-5xl font-bold text-white transition-colors duration-700 scramble-title">Mission Logs</h3>
          </div>
          <p className="text-slate-500 max-w-md text-sm italic">
            "We have to be better. We have to be the best." - Peter Parker
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[200px]">
          ...
          >
            <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity duration-700">
              <ShieldAlert size={200} className="text-primary transition-colors duration-700" />
            </div>
            <CardHeader>
              <div className="flex items-center gap-2 text-primary mb-2 transition-colors duration-700">
                <div className="w-2 h-2 bg-primary rounded-full animate-ping"></div>
                <span className="text-xs font-bold uppercase tracking-widest">Suit Configuration</span>
              </div>
              <CardTitle className="text-2xl text-white">Spider-Suit Tech</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          >
             <div className="flex items-center gap-2 text-primary mb-2 transition-colors duration-700">
               <Newspaper size={18} />
               <span className="text-[10px] font-black uppercase tracking-widest">Daily Bugle</span>
             </div>
             <h3 className="text-white font-bold leading-tight scramble-title">Tech Notes // Upcoming Features</h3>
             <p className="text-slate-500 text-[10px] mt-2 italic leading-relaxed">
               "Scanning the city for new tech stacks. Documentation in progress."
             </p>
             <div className="mt-4 flex items-center gap-2">
               <div className="w-1 h-1 bg-primary rounded-full animate-pulse transition-colors duration-700"></div>
               <span className="text-[8px] text-primary uppercase font-bold transition-colors duration-700">Encrypted Data</span>
             </div>
          </Card>
          ...
          >
             ...
             <div className="relative z-10 flex flex-col items-center">
               <ShieldCheck className="hover-icon text-white mb-2 animate-pulse" size={32} />
               <h3 className="text-white font-black uppercase tracking-tighter text-xl scramble-title">Activate Mission</h3>
